...
// TaskQueueRecorder records ALL task writes
...
// NewTaskQueueRecorder creates a recorder for history task writes.
...
// Observe records one successful history task write.
func (r *TaskQueueRecorder) Observe(write testhooks.HistoryTasksWritten) {
